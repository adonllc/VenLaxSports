  ...
  return (
    <div className="relative w-full bg-zinc-950 text-white overflow-hidden font-sans">
      <style>{`
        ...
        .gtrust-fade-in       { animation: fadeSlideIn 0.8s ease-out forwards; opacity: 0; }
        .gtrust-marquee       { animation: marquee 40s linear infinite; }
        .gtrust-delay-100     { animation-delay: 0.1s; }
        .gtrust-delay-200     { animation-delay: 0.2s; }
        .gtrust-delay-300     { animation-delay: 0.3s; }
        .gtrust-delay-400     { animation-delay: 0.4s; }
        .gtrust-delay-500     { animation-delay: 0.5s; }
      `}</style>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1579952363873-27f3bade9f55?w=1920&q=80)",
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pt-24 pb-12 sm:px-6 md:pt-32 md:pb-20 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            {/* Badge */}
            <div className="gtrust-fade-in gtrust-delay-100">
            ...
            {/* Heading */}
            <h1
              className="gtrust-fade-in gtrust-delay-200 text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-medium tracking-tighter leading-[0.9]"
              style={{
            ...
            {/* Description */}
            <p className="gtrust-fade-in gtrust-delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
            ...
            {/* CTA Buttons */}
            <div className="gtrust-fade-in gtrust-delay-400 flex flex-col sm:flex-row gap-4">
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
            ...
            {/* Stats Card */}
            <div className="gtrust-fade-in gtrust-delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
            ...
            {/* Marquee Card */}
            <div className="gtrust-fade-in gtrust-delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-8 backdrop-blur-xl">
              ...
              >
                <div className="gtrust-marquee flex gap-12 whitespace-nowrap px-4">
