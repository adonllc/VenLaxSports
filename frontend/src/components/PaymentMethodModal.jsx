 ...
 */
export default function PaymentMethodModal({ open, onClose, league, promoCode, inviteToken, onSuccess }) {
  ...
  const handleStripe = async () => {
    ...
    try {
      ...
      if (inviteToken) { payload.invite_token = inviteToken; payload.is_doubles = true; }
