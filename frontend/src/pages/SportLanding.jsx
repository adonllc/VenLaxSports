...
const SPORT_META = {
  tennis: {
    ...
    description: "Compete in structured tennis leagues with NTRP-rated divisions, best-of-3 set formats, and professional scorekeeping across top USA & India courts.",
    formats: ["Singles", "Doubles", "Mixed Doubles"],
    scoring: "Best-of-3 sets with match tiebreak at 6-6",
    rating: "NTRP Rating System (2.0 - 7.0)",
    image: "https://images.unsplash.com/photo-1696661115319-a9b6801e2571?w=1200&q=80",
    features: ["NTRP Rating Tracking", "Best-of-3 Sets", "Match Tiebreak Rules", "Weekly Scheduling", "Online Score Reporting", "Live Standings"],
  },
  cricket: {
    label: "Cricket", icon: "🏏", color: "#2563EB",
    badgeClass: "sport-badge-cricket", colorClass: "text-cricket", bgClass: "bg-cricket-bg",
    tagline: "T10, T20 & corporate cricket leagues across India & USA",
    description: "Join structured corporate and amateur cricket leagues with professional umpires, NRR tracking, powerplay rules, and top facilities in India's major cities.",
  ...
  pickleball: {
    ...
    tagline: "America's fastest-growing sport, now in organized leagues",
    description: "Ride the pickleball wave with organized singles and doubles leagues. Rally scoring, win-by-2 rules, and DUPR-style ratings across top USA facilities.",
    formats: ["Singles", "Doubles", "Mixed Doubles"],
    scoring: "Rally scoring to 11, win by 2",
    rating: "DUPR-style Rating System",
    image: "https://images.unsplash.com/photo-1777382141965-68d47862eaf9?w=1200&q=80",
    features: ["Rally Scoring", "Win-by-2 Rules", "DUPR Ratings", "Flexible Scheduling", "Beginner Friendly", "Growing Community"],
  },
};
