...
const SPORT_META = {
  tennis: {
    ...
    description: "Compete in structured tennis leagues with NTRP-rated divisions, best-of-3 set formats, and professional scorekeeping across top courts.",
  ...
  pickleball: {
    ...
    description: "Ride the pickleball wave with organized singles and doubles leagues. Rally scoring, win-by-2 rules, and DUPR-style ratings across top facilities.",
    formats: ["Singles", "Doubles", "Mixed Doubles"],
