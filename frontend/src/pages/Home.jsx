    ...
    <div className="bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          {/* Accent badge */}
          <motion.div
            className="inline-flex items-center gap-2 mb-8 px-4 py-2 bg-gray-100 rounded-full"
          ...
          >
            ...
            />
            <span className="text-sm font-semibold text-gray-700">SPRING SEASON LIVE</span>
          </motion.div>

          {/* Main headline */}
          <motion.h1
            className="text-6xl md:text-7xl font-black leading-tight mb-6 text-gray-900"
          ...
          >
            <motion.button
              ...
              className="px-8 py-4 bg-gray-900 text-white rounded-lg font-semibold transition-all"
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05, y: -3, boxShadow: "0 12px 32px rgba(16,185,129,0.3)" }}
              whileTap={{ scale: 0.95 }}
            >
              Register a Team →
            </motion.button>
          ...
          {/* Stats row */}
          <motion.div
            className="flex flex-col md:flex-row gap-8 justify-center text-sm font-semibold text-gray-600"
            initial="hidden"
            animate="visible"
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div
            className="bg-white border border-gray-300 rounded-lg p-8 mb-12"
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={viewportConfig}
          ...
          >
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={viewportConfig}>
                <label className="block text-sm font-bold text-gray-900 mb-4">Select Sport</label>
                  ...
                  {["tennis", "pickleball"].map((s) => (
                    <motion.button
                      ...
                      className={`px-6 py-3 rounded-md font-semibold transition-all ${
                        sport === s ? "bg-white text-gray-900 shadow-md" : "bg-transparent text-gray-600"
                      }`}
              ...
              {/* Skill slider */}
              <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={viewportConfig}>
                <label className="block text-sm font-bold text-gray-900 mb-4">Your Skill Level</label>
                <div className="flex gap-4 items-center">
                  ...
                  <input
                    ...
                    className="flex-1 h-1.5 bg-gray-300 rounded-full cursor-pointer"
                    style={{
